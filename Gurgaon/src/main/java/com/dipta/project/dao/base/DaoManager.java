...
public enum DaoManager {
	USER("userdao",IUserDao.class), WORKFLOWDAO("workflowdao",IWorkFlowDao.class), PROJECTDAO("projectDao",IProjectDao.class),
	EMAIL("emaildao",IEmailDao.class), CLIENTREQUEST("clientrequestdao",IClientRequestedDao.class), SCHEDULERDAO("schedulerdao",ISchedulerDao.class);
