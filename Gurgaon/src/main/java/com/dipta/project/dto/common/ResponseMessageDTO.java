...
@XmlSeeAlso({HashMap.class,UserDTO.class,ArrayList.class,UserProjectCollection.class, ProjectDTO.class, AclDto.class, DashboardDto.class, WorkFlowMasterDto.class,WorkFlowUsersMapDto.class,WorkFlowSearchGridDto.class,WorkFlowRecordsCountDto.class, CommonExternalFilterDto.class,WorkflowCoreDTO.class,ProjectConfigurationDto.class,WorkItemDto.class,WorkItemNotificationDto.class,WorkItemTicketDto.class,WorkItemWorkFlowDto.class,ProjectTemplateMasterDto.class,ProjectTemplateCountsDto.class, GeoWidgetDtos.class, CommonSearchFilterDto.class,String.class,ProjectStatusCollectionDto.class,TemplateServiceMasterDto.class,UserDTOCollection.class,FeedMasterDto.class,FeedMasterDtoCollection.class,MappingCollection.class,EtlPrestageMasterDto.class,EtlPrestageMapDto.class,ProjectFeedDto.class,EtlCreateMappingDto.class,EtlStageFieldMapDto.class,EtlIDRuleMasterDto.class,EtlTransformMasterDto.class,SourceTargetInfoDto.class,EtlIDRuleDetailDto.class,TransformationCollection.class,EtlFeedMatchingDetailDto.class,EtlMatchingColumnDetailDto.class,EtlMatchingScoreDetailDto.class,EtlMatchMasterColumnsDto.class,ReplaceCategoryCollection.class,FeedSetupDetailsDto.class,HierarchyDataCollection.class,HierarchyEntityDTO.class,HierarchyMasterFilterDTO.class,CodApiRequestDto.class})
