...
public class EncryptionControl {
	...
	private static final boolean enabled = true; // PropertyUtility.getValueBoolean(ApplicationConstants.CONFIGURATIONSBUNDLE.getValue(), ApplicationConstants.ENCRIPTIONENABLED.getValue(),false);;
	private static final String serverKey = PropertyUtility.getValueString(ApplicationConstants.CONFIGURATIONSBUNDLE.getValue(), ApplicationConstants.SERVERKEY.getValue(),"SSS");;
